...
WebUI.click(findTestObject('Object Repository/Page_Login  Sistema de Gestin Comercial SGC/div_Entrar'))
...
WebUI.click(findTestObject('Object Repository/Page_Procesos  Sistema SGC/li_Listados de Consumo'))
...
WebUI.click(findTestObject('Object Repository/Page_Parmetros Para Listado De Servicios Co_c1535a/td_Ciclo 291- (201802)'))
...
T1 = WebUI.getText(findTestObject('Page_Listado de servicios con sobreconsumo123/td_OCTAVIOALVAREZ1'), FailureHandling.STOP_ON_FAILURE)
