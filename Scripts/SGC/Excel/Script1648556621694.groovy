...
WebUI.click(findTestObject('Object Repository/Page_Procesos  Sistema SGC/span_Listados de Consumo'))

WebUI.click(findTestObject('Object Repository/Page_Procesos  Sistema SGC/span_Listado de servicios con sobreconsumo'))
...
T1 = WebUI.getText(findTestObject('Object Repository/Page_Listado de servicios con sobreconsumo/nobr_GLORIASALGADOLOPEZ'))

T2 = WebUI.getText(findTestObject('Object Repository/Page_Listado de servicios con sobreconsumo/nobr_EDUARDOLAVADOS'))

WebUI.click(findTestObject('Object Repository/Page_Listado de servicios con sobreconsumo/img_Cargando_xdocView_Splitter_Toolbar_Menu_8b5a71'))
...
E1 = ExcelKeywords.getCellByIndex(sheet01, 1, 15)

E2 = ExcelKeywords.getCellByIndex(sheet01, 2, 15)
