...
WebUI.navigateToUrl('https://sgcata.aguasnuevas.cl/PRO_ParamGenerarDTE.aspx')

WebUI.click(findTestObject('Object Repository/Page_Generacin DTE/img_Ciclo_xrpnlLote_xddlCiclo_B-1Img'))

WebUI.click(findTestObject('Object Repository/Page_Generacin DTE/td_Ciclo 288- (202208)'))

WebUI.click(findTestObject('Object Repository/Page_Generacin DTE/input_Desde_ASPxRoundPanel2xtxtNoDocumentoDesde'))

WebUI.setText(findTestObject('Object Repository/Page_Generacin DTE/input_Hasta_ASPxRoundPanel2xtxtNoDocumentoHasta'), '3727945')
