...
WebUI.navigateToUrl('https://sgcara.aguasnuevas.cl/PRO_ParamGenerarDTE.aspx')
...
WebUI.setText(findTestObject('Object Repository/Page_Generacin DTE/input_Hasta_ASPxRoundPanel2xtxtNoDocumentoHasta'), '26350530')
...
File file = new File((GlobalVariable.Ruta_Descargas+'AA-' + todayFormat) + '-01-39.txt')
