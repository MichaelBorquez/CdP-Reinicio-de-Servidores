...
WebUI.navigateToUrl('https://adfs-sso2.aguasnuevas.cl/adfs/ls?wa=wsignin1.0&wtrealm=https%3a%2f%2fpsaqa.aguasnuevas.cl&wctx=rm%3d0%26id%3dpassive%26ru%3d%252fLogin.aspx&wct=2022-04-29T02%3a56%3a15Z&wreply=https%3a%2f%2fpsaqa.aguasnuevas.cl%2fDefault.aspx')
...
if (true) {
    WebUI.verifyElementText(findTestObject('Page_Asignar/span_No se puede encontrar una parte de la _42178b'), 'No se puede encontrar una parte de la ruta de acceso \'D:\\Intranet\\SISPAR\\FrontOfficeSISPAR\\Adjuntos\\Requerimientos\'.')
} else {
    WebUI.verifyElementText(findTestObject('Page_Asignar/span_No se puede encontrar una parte de la _42178b'), '123')
}
