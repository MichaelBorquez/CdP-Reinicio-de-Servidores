...
WebUI.sendKeys(findTestObject('Object Repository/Page_Aguas Araucana/input_PAGA AQU_pass'), Keys.chord(Keys.ENTER))

WebUI.verifyElementText(findTestObject('Page_Ficha comercial/strong_Bienvenido (a)'), 'Bienvenido (a):')
