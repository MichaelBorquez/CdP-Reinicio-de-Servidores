...
WebUI.click(findTestObject('Page_Aguas Araucana/input_PAGA AQU_enviar'))

T1 = WebUI.getText(findTestObject('Page_Ficha comercial/td_Pago empresas externas - Web Pay - Email'), FailureHandling.STOP_ON_FAILURE)
