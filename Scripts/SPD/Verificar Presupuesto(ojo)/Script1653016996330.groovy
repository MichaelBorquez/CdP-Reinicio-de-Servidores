...
WebUI.click(findTestObject('Object Repository/Page_Bienvenido al Sistema de Produccin y D_470a8a/td_Presupuesto'))

WebUI.click(findTestObject('Object Repository/Page_Bienvenido al Sistema de Produccin y D_470a8a/td_Listar'))

T1 = WebUI.getText(findTestObject('Object Repository/Page_Listado/nobr_Depuracin'))

if (T1.length() == 0) {
    assert false
}

WebUI.click(findTestObject('Object Repository/Page_Listado/img'))

T2 = WebUI.getText(findTestObject('Page_Listado/nobr_Abierto1'))
