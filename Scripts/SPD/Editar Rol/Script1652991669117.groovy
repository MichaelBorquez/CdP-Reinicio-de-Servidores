...
WebUI.click(findTestObject('Object Repository/Page_Bienvenido al Sistema de Produccin y D_470a8a/td_Parmetros del Sistema'))

WebUI.click(findTestObject('Object Repository/Page_Bienvenido al Sistema de Produccin y D_470a8a/td_Usuarios'))

WebUI.click(findTestObject('Object Repository/Page_Listar Usuarios/img'))

WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Guardar Usuario/select_SeleccionarAdministradorAmbienteAnal_0383d2'), 
    '4', true)

WebUI.delay(1)

WebUI.verifyElementText(findTestObject('Page_Guardar Usuario/td_Backup'), 'Backup:')
