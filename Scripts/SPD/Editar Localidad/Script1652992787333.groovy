...
WebUI.verifyElementText(findTestObject('Page_Mantenedor de Localidades/span_El registro se actualiz correctamente'), 'El registro se actualizó correctamente.')
