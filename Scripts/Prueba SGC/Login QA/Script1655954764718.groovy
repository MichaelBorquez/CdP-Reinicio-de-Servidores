...
WebUI.setEncryptedText(findTestObject('Object Repository/Page_Login  Sistema de Gestin Comercial SGC/input_Contrasea_txtxContrasena'), 
    '+PXcWh3WWpMwVRuyja5I1w==')

WebUI.click(findTestObject('Object Repository/Page_Login  Sistema de Gestin Comercial SGC/td_Entrar--aspxAddHoverItems(btnxEntrar,dxb_cab8ba'))
