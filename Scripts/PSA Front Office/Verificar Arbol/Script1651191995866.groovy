...
WebUI.verifyElementText(findTestObject('Page_Bienvenido Plataforma de Atencin de So_163357/td_Araucana'), 'Araucanía')
...
WebUI.verifyElementText(findTestObject('Page_Bienvenido Plataforma de Atencin de So_163357/td_Gerencia Regional - Araucana'), 
    'Gerencia Regional - Araucanía')
...
WebUI.verifyElementText(findTestObject('Page_Bienvenido Plataforma de Atencin de So_163357/td_Administracin Psa Ara'), 'Administración Psa Ara')
