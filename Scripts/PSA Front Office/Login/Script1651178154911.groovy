...
WebUI.verifyElementText(findTestObject('Page_Bienvenido Plataforma de Atencin de Solicitudes/span_Nueva Atencin'), 'Nueva Atención')

WebUI.verifyElementText(findTestObject('Page_Bienvenido Plataforma de Atencin de Solicitudes/span_Consulta'), 'Consulta')

WebUI.verifyElementText(findTestObject('Page_Bienvenido Plataforma de Atencin de Solicitudes/span_Grficos'), 'Gráficos')
